...
export function IconCake(props) {
  return (
    <svg {...base} {...props}>
      <path d="M12 3c.9.8 1.4 1.6 1.4 2.3 0 .8-.6 1.4-1.4 1.4s-1.4-.6-1.4-1.4c0-.7.5-1.5 1.4-2.3Z" />
      <path d="M12 6.7V10" />
      <path d="M5 21v-6.2a2.8 2.8 0 0 1 2.8-2.8h8.4A2.8 2.8 0 0 1 19 14.8V21" />
      <path d="M3 21h18" />
      <path d="M5 16.4c1.2 0 1.2 1.3 2.3 1.3s1.2-1.3 2.3-1.3 1.2 1.3 2.4 1.3 1.2-1.3 2.3-1.3 1.2 1.3 2.4 1.3 1.1-1.3 2.3-1.3" />
    </svg>
  )
}
